...
| 44 | Gate verification: a steppable device-gate playtest protocol that closes the Bucket-A gates | in progress | [phase-44-gate-verification](./phase-44-gate-verification/) |
